...
export default function CategorySidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 left-0 z-50 h-full w-72 bg-white border-r border-gray-200 p-4 overflow-y-auto
          transform transition-transform duration-300 ease-in-out
          ${isOpen ? "translate-x-0" : "-translate-x-full"}
          lg:static lg:translate-x-0 lg:w-64 lg:shrink-0 lg:z-auto
        `}
      >
        {/* 모바일 닫기 버튼 */}
        <div className="flex items-center justify-between mb-4 lg:hidden">
          ...
          <button
            onClick={onClose}
            className="p-1 rounded-lg hover:bg-gray-100 text-2xl leading-none"
          >
            ✕
          </button>
        </div>
